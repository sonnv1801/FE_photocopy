            ...
            <div className="bg-[#d4f7e8] col-xl-4 col-sm-12">
              <div className="grid grid-cols-2  w-[80%] m-12 text-[21px] font-medium ">
                ...
                <div lassName=" cursor-pointer">
                  <a href="#!"> Các câu hỏi thường gặp về Máy Photocopy​</a>
                </div>
              </div>
              <div className="border-t-[1px] border-white">
                <div className="w-[80%] m-12 text-[14px]  ">
        ...
        <div className="w-full mt-24 sm-infor-contact">
          <div className="row">
            <div className="col-xl-6 col-sm-12 sm-map-contact">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d31337.691039970414!2d106.84846259087855!3d10.947399229076018!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3174de735ee11b35%3A0x23a59921dea85593!2zS3A3LCBMb25nIELDrG5oLCBUcC4gQmnDqm4gSMOyYSwgxJDhu5NuZyBOYWksIFZp4buHdCBOYW0!5e0!3m2!1svi!2s!4v1689177700069!5m2!1svi!2s"
                width="600"
                height="450"
                allowfullscreen=""
                loading="lazy"
            ...
            <div className="col-xl-6 col-sm-12">
              ...
              <div>
                ...
                <div className="ml-4 flex sm-infor-address">
                  ...
                  <p className="w-[50%]">
                    Bãi đậu xe của Cửa hàng kinh doanh Máy Photocopy Lam Anh đã
                    được di dời về phía bắc của tòa nhà.
                  </p>
                </div>
          ...
          <div className="grid grid-cols-2 sm-body-form-contact">
            <div className="w-full ml-12 mt-24 sm-form-contact">
              ...
              <p className="flex mt-8 w-full text-[13px]">
                ...
                <input
                  type="text"
                  className=" pl-4 ml-8 h-10 w-full border-b-[1px]  font-light"
                  id="name"
                  placeholder="Nhập thông tin Họ và Tên"
                />
              </p>
              <p className="flex mt-8 w-full text-[13px] ">
                <label className="w-[140px] mt-2 font-medium">Email *</label>
                <br />
                <input
                  type="text"
                  className="font-light pl-4 ml-8 h-10 w-full border-b-[1px] border-gray-300 text-gray-900 "
                  id="name"
                  placeholder="Email: tranvana@gmail.com"
                />
              </p>
              <p className="flex mt-8 w-full text-[13px] ">
                <label className="w-[140px] mt-2 font-medium">
                  Số điện thoại *
                </label>
                <br />
                <input
                  ...
                  className="font-light pl-4 ml-8 h-10 w-full border-b-[1px] border-gray-300 text-gray-900 "
                  id="name"
                  placeholder="SĐT: 09123456789"
                />
              </p>
              <p className="flex mt-8 w-full text-[13px] ">
                <label className="w-[140px] mt-2 font-medium">Nội dung</label>
                <br />
                <textarea
                  name="note"
                  id="note"
              ...
              <p className="mt-4">
                <span>
                  <label className="flex">
                    <input
                      type="checkbox"
                      className="h-[21px] w-[21px] cursor-pointer  rounded-[10px] bg-[#ffffff]"
                    />
                    <span className="text-[13px] px-2">
                      Tôi đã đọc và chấp nhận Chính sách quyền riêng tư
                    </span>
                  </label>
                </span>
              </p>
      ...
      <div className="w-full mt-24 bg-white py-[80px] sm-bottom-contact">
        ...
        <div className="grid grid-cols-2 w-[40%] mx-auto mt-8 sm-contact-hotline">
          <div className=" flex">
            ...
            <p className="text-center my-auto mx-4">Đặt lịch hẹn</p>
          </div>
          <div className=" flex ">
            <a className="bg-green-200 rounded-full p-2">
              <svg
            ...
            <p className="text-center my-auto mx-4">Hotline: 19002297</p>
          </div>
        </div>
        ...
        <div className="w-[90%] m-auto py-16 sm-hcm-pt">
          ...
          <div className="row">
              ...
              <div className="sm-hotline">
                <ul>
                  ...
                  <li className="mt-4 cursor-pointer">
                    <span className="flex text-[#029967] text-[18px] font-medium">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
            ...
            <div className="col-xl-4 col-sm-12">
              ...
              <div>
                <ul>
                  <li className="float-left w-[50%] mb-[10px] pr-[10px] text-[15px] font-light">
            ...
            <div className="col-xl-4 col-sm-12">
              ...
              <div>
                <input
                  ...
                  className=" w-full py-[17px] pl-[16px] text-[14px] rounded-[10px] bg-[#d4f7e8] "
                />
                <button
                  type="submit"
                  value="Đăng ký"
